...
// Creamos la conexcion con fireStore
const db = useFirestore()
//Obtenemos referencia al documento de la coleccion de fireStore => 1. base de datos, 2 colleccion, 3. el ID
    ...
    <v-card max-width="800" flat class="mx-auto my-10">
        ...
        <v-form class="mt-10">
            ...
            <div class="my-5">
                ...
                <img v-else class="w-50" :src="propiedad?.imagen" :alt="'imagen de ' + propiedad?.titulo">
            </div>
