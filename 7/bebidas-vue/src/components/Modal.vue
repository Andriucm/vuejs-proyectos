                ...
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <TransitionChild as="template" enter="ease-out duration-300"
                        ...
                        <DialogPanel
                            ...
                            <div>
                                <div class="mt-3">
                                    <DialogTitle as="h3" class="text-4xl font-extrabold  text-gray-900 my-5">
                                        {{ bebidas.receta.strDrink }}
                                    </DialogTitle>
                                    <img class="mx-auto w-96" :src="bebidas.receta.strDrinkThumb" :alt="'Imagen de ' + bebidas.receta.strDrink">
                                    <DialogTitle as="h3" class="text-4xl font-extrabold  text-gray-900 my-5">
                            ...
                            <div class="mt-5 sm:mt-6 flex justify-between gap-4">
                                <button @click="modal.handleClickModal()" type="button"
                                    class="w-full rounder bg-gray-600 p-3 font-bold uppercase text-white shadow hover:bg-gray-500">
                                    Cerrar</button>
                                    <button @click="favoritos.handleClickFavorito()" type="button" class="w-full rounder bg-orange-600 p-3 font-bold uppercase text-white shadow hover:bg-orange-500">{{modal.textoBoton}}</button>
                            </div>
                        </DialogPanel>
                    </TransitionChild>
                </div>
