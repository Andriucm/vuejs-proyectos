...
defineEmits(['agregar-carrito', 'decrementar-cantidad', 'incrementar-cantidad', 'eliminar-producto', 'vaciar-carrito'])
                                    ...
                                    <tbody>
                                        <tr v-for="producto in carrito" :key="producto.id">
                                            ...
                                            <td class="flex align-items-start gap-4">
                                                <button @click="$emit('decrementar-cantidad', producto.id)" type="button"
                                                    class="btn btn-dark">
                                                    -
                                                </button>
                                                {{ producto.cantidad }}
                                                <button @click="$emit('incrementar-cantidad', producto.id)" type="button"
                                                    class="btn btn-dark">
                                                    +
                                                </button>
                                            </td>
                                            <td>
                                                <button @click="$emit('eliminar-producto', producto.id)"
